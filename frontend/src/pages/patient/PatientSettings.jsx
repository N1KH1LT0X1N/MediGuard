...
const PatientSettings = () => {
  ...
  useEffect(() => {
    ...
    const userId = localStorage.getItem('mediguard_user_id') || 'Not set';
  ...
  const createNewPatient = () => {
    ...
    localStorage.setItem('mediguard_user_id', newUserId);
  ...
  const clearCurrentPatient = () => {
    if (window.confirm('Are you sure you want to clear your current patient ID? This will create a new patient on your next prediction.')) {
      localStorage.removeItem('mediguard_user_id');
        ...
        <div className="bg-white rounded-xl p-6 border-2 border-[#222123] shadow-lg">
          ...
          <div className="mb-8 p-4 bg-[#7FFF00] bg-opacity-10 rounded-lg border-2 border-[#7FFF00]">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#7FFF00] text-black rounded-lg hover:bg-[#6ee000] transition-colors font-bold border-2 border-[#222123]"
            >
              Create New Patient
            </button>
          </div>
          ...
          <div className="mt-8 p-4 bg-yellow-50 rounded-lg border-2 border-yellow-200">
            ...
            <p className="text-sm text-yellow-800">
              Then refresh the page and make a prediction - a new patient ID will be automatically created.
            </p>
          </div>
